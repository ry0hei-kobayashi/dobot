    ...
    response = openai.chat.completions.create(
        ...
        messages=[
            ...
            {"role": "user", "content": [
                ...
                #{"type": "text", "text": "3*3のグリッドが描かれた紙の上に数字付きのブロックが配置されています．各数字のブロックがグリッド上のどこのマスに存在するのかを認識してください．またグリッド上を左上のマスから確認していき，各マスに存在する数字を順に\",\"区切りで出力してください．ブロックが存在し無いマスには0を挿入してください．一番左のマスに数字が存在しない場合もあります．その時は1マス目に0を挿入してください．無駄な解説はなしで結果のみを出力してください．"},  # ここに質問を書く
